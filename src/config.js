...
const SEARCH_BASE_URL = `${API_URL}search/tv?api_key=${API_KEY}&language=en-US&query=`;
const POPULAR_BASE_URL = `${API_URL}tv/popular?api_key=${API_KEY}&language=en-US`;
const TOPRATED_BASE_URL = `${API_URL}tv/top_rated?api_key=${API_KEY}&language=en-US`;
